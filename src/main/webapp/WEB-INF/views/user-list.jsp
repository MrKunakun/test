...
<body>
	<div>
    <table class="easyui-datagrid" id="userList" title="用户列表" data-options="singleSelect:false,collapsible:true,pagination:true,url:'/rest/user/data/list',method:'get',pageSize:5,toolbar:toolbar,pageList:[2,5,10]">
	    <thead>
	        <tr>
...
<div id="userAdd" class="easyui-window" title="新增用户" data-options="modal:true,closed:true,iconCls:'icon-save',
		href:'/rest/user/add'" style="width:400px;height:300px;padding:10px;">
        The window content.
</div>
